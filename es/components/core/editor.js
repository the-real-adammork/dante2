...
var DanteEditor = function (_React$Component) {
  ...
  DanteEditor.prototype.forceRender = function forceRender(editorState) {
    ...
    var newEditorState = EditorState.createWithContent(content, this.decorator);
  ...
  DanteEditor.prototype.handleHTMLPaste = function handleHTMLPaste(text, html) {
    ...
    var newContentState = customHTML2Content(html, this.extendedBlockRenderMap);
  ...
  DanteEditor.prototype.enableEditable = function enableEditable() {
    this.closePopOvers();
    console.log("out !!");
  ...
  DanteEditor.prototype.showPopLinkOver = function showPopLinkOver(el) {
    ...
    var parent_el = ReactDOM.findDOMNode(this);
